  ...
  return (
    <>
      ...
      <div className="container">
        <h2 className={titleChanged ? "title-changed" : ""}>
          {titleChanged ? "Its Pomodoro Time" : "25 + 5 Clock"}
        </h2>
        ...
        <div className="clock-wrapper">
          <div className="clock">
            ...
            <h3 id="time-left">{formateTime()}</h3>
          </div>
          <button onClick={clickPlay} id="start_stop">
            Start/Stop
          </button>
          <button onClick={clickReset} id="reset">
            Reset
          </button>
        </div>
        <audio
